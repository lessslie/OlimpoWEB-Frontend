                  ...
                  <a
                    ...
                    onClick={(e) => {
                      if (!formData.name || !formData.message) {
                        e.preventDefault();
                        toast.error('Por favor completa al menos tu nombre y mensaje');
                      }
                    }}
                  >
              ...
              <div className="mt-6 space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-base text-gray-500">
                    <p>Dirección</p>
                    <p className="mt-1">Calle Pringles entre Saavedra y Córdoba</p>
                    <p>Quines, San Luis</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-base text-gray-500">
                    <p>Teléfono</p>
                    <p className="mt-1">
                      <a href="https://wa.me/5492304355852" target="_blank" rel="noopener noreferrer" className="hover:underline">
                        +542304355852
                      </a>
                    </p>
                  </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-base text-gray-500">
                    <p>Horario</p>
                    <p className="mt-1">Lunes a Viernes: 07:00 - 12:30, 14:00 - 23:00</p>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-base text-gray-500">
                    <p>Email</p>
                    <p className="mt-1">
                      <a href="mailto:walterdamianmaidana100@gmail.com" className="hover:underline">
        ...
        <div className="mt-12">
          ...
          <div className="bg-white shadow overflow-hidden rounded-lg">
            ...
            <div className="px-4 py-4 sm:px-6 text-center text-sm text-gray-500">
              Si no puedes ver el mapa, <a href="https://www.google.com/maps/place/Olimpo+Gym/@-32.2358553,-65.8085623,745m/data=!3m2!1e3!4b1!4m6!3m5!1s0x95d4917ffe2738c7:0x5af9065b5a24a2cd!8m2!3d-32.2358553!4d-65.8059874!16s%2Fg%2F11vdnsjycz?hl=es-419&entry=ttu" target="_blank" rel="noopener noreferrer" className="text-gray-900 font-medium hover:text-gray-700">haz clic aquí para ver en Google Maps</a>
            </div>
          </div>
        </div>
      </div>
