    ...
    try {
      ...
      const mockPosts: BlogPost[] = [
        ...
        },
        {
          ...
          content: '<p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p><h2>Técnicas básicas</h2><p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>',
          image_url: 'https://via.placeholder.com/800x400',
          category: 'Kickboxing',
          author_id: '2',
        ...
        },
        {
          ...
          content: '<p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p><h3>Antes del entrenamiento</h3><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p><h3>Después del entrenamiento</h3><p>Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>',
          image_url: 'https://via.placeholder.com/800x400',
          category: 'Nutrición',
          author_id: '1',
          author_name: 'Juan Pérez',
        ...
        },
        {
          ...
          content: '<p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p><ul><li>Competición regional de kickboxing</li><li>Maratón benéfica</li><li>Seminario de nutrición deportiva</li></ul>',
          image_url: 'https://via.placeholder.com/800x400',
          category: 'Eventos',
          author_id: '3',
