...
// Temporalmente usar un componente simulado en lugar de react-qr-scanner
    ...
    Promise.resolve(
      (props: {
        ...
        <div className="aspect-square bg-gray-100 rounded-lg flex flex-col items-center justify-center p-4">
          <p className="text-gray-600 mb-4">Escáner QR (simulado)</p>
          <button
            onClick={() =>
              props.onScan &&
              props.onScan({ text: "https://example.com/simulated-qr-code" })
            }
        ...
        <div className="bg-white shadow-lg rounded-lg p-6">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-blue-50 rounded-lg">
              ...
              <p>
                Escanea el código QR del usuario para registrar su asistencia al
                gimnasio. El sistema verificará automáticamente el tipo de
                membresía y mostrará la información relevante.
              </p>
            </div>
            ...
            <div className="p-4 bg-green-50 rounded-lg">
              ...
              <ul className="list-disc list-inside space-y-2">
                <li>
                  <span className="font-medium">Membresía mensual:</span>{" "}
                  Confirmación de ingreso y aviso si vence al día siguiente.
                </li>
                <li>
                  <span className="font-medium">
                    Kickboxing 2 veces/semana:
                  </span>{" "}
                  Muestra cuántas entradas quedan en la semana.
                </li>
                <li>
                  <span className="font-medium">
                    Kickboxing 3 veces/semana:
                  </span>{" "}
                  Muestra cuántas entradas quedan en la semana.
                </li>
              </ul>
