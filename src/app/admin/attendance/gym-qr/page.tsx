...
export default function GymQrPage() {
  ...
  useEffect(() => {
    ...
    const qrData = {
      type: "gym_attendance",
      gym_id: "1",
      timestamp: new Date().toISOString().split("T")[0], // Fecha actual
    };

    // URL a la que redirigirá el QR (la nueva página de asistencia)
    const baseUrl =
      process.env.NEXT_PUBLIC_FRONTEND_URL ||
      "https://olimpo-web-frontend.vercel.app";
    const qrUrl = `${baseUrl}/asistencia?data=${encodeURIComponent(
        ...
        <div className="text-center">
          <div className="mb-8">
            <h2 className="text-2xl font-bold mb-2">
              Código QR para registro de asistencias
            </h2>
            <p className="text-gray-600 mb-6">
              Los usuarios pueden escanear este código QR para registrar su
              asistencia al gimnasio.
              <br />
              Una vez escaneado, serán redirigidos a la página de asistencia
              donde podrán iniciar sesión (si es necesario) y su asistencia será
          ...
          <div className="bg-gray-100 p-4 rounded-lg mb-8 max-w-2xl mx-auto">
            <h3 className="font-semibold mb-2">URL del código QR:</h3>
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg text-blue-800 max-w-xl mx-auto">
            <h3 className="font-semibold mb-2">Instrucciones para el uso:</h3>
            <ol className="list-decimal list-inside text-left space-y-2">
              <li>
                Imprima este código QR y colóquelo en la entrada del gimnasio.
              </li>
              <li>
                Los usuarios deben escanear el código con la cámara de su
                teléfono.
              </li>
              <li>
                Serán dirigidos a una página donde iniciarán sesión (si es
                necesario).
              </li>
              <li>
                Una vez autenticados, su asistencia se registrará
                automáticamente.
              </li>
            </ol>
          </div>
